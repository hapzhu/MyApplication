 ...
 */
public class RetrofixDemoActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retrofix_demo);
        ...
        mResultTextView= (TextView) findViewById(R.id.tv_result_str);
...
//            mAuthTask.execute((Void) null);
    ...
    private void doLogin() {
        ...
        Call<ResponseBody> call=service.login4Path("HttpRequestDemo",email,password);
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(RetrofixDemoActivity.this,
